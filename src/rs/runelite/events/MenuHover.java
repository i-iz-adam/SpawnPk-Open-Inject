...
/* JADX INFO: loaded from: client-final.jar:rs/runelite/events/MenuHover.class */
public class MenuHover {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MenuHover)) {
            return false;
        }
        MenuHover menuHover = (MenuHover) obj;
        if (!menuHover.canEqual(this) || getRow() != menuHover.getRow() || getMenuId() != menuHover.getMenuId() || getMenuCmd1() != menuHover.getMenuCmd1() || getMenuCmd2() != menuHover.getMenuCmd2() || getMenuCmd3() != menuHover.getMenuCmd3() || getMenuCmd4() != menuHover.getMenuCmd4()) {
            return false;
        }
        String tooltip = getTooltip();
        String tooltip2 = menuHover.getTooltip();
        if (tooltip == null) {
    ...
    protected boolean canEqual(Object obj) {
        return obj instanceof MenuHover;
    }
    ...
    public String toString() {
        return "MenuHover(tooltip=" + getTooltip() + ", row=" + getRow() + ", menuId=" + getMenuId() + ", menuCmd1=" + getMenuCmd1() + ", menuCmd2=" + getMenuCmd2() + ", menuCmd3=" + getMenuCmd3() + ", menuCmd4=" + getMenuCmd4() + ")";
    }
}
