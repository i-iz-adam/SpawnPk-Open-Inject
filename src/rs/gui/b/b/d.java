...
public class d {
    ...
    private String a(String string, int n, boolean bl) {
        if (bl) {
            if (n == 1) {
                return b;
            }
    ...
    public void a(String string) {
        ...
        for (int i = 1; i <= 3; ++i) {
            file = new File(this.a(string, i, false));
    ...
    public void a(String string, List<Loadout> list) {
        ...
        try {
            ...
            for (Loadout object2 : list) {
                rs.gui.b.b.c.a((DataOutputStream)dataOutputStream, (Loadout)object2);
            }
    ...
    public LoadoutGroup a(String string, boolean bl) {
        ...
        try {
            if (file.exists()) {
                ...
                if (!bl) {
                    rs.gui.b.b.c.a((DataInputStream)dataInputStream, (LoadoutGroup)c2);
                } else {
                    ...
                    do {
                        ...
                        Loadout a2 = new Loadout(string2);
                        if (file3.exists()) {
                            n4 = dataInputStream.readInt();
                            a2.a(rs.gui.b.a$a.a((int)n4));
