...
public class d
extends LinkedHashMap<String, LoadoutGroup> {
    private h a;
    private String b;
    private rs.gui.b.Loadout c;

    public d(h h2) {
        this.a = h2;
    }

    public void a(String string, rs.gui.b.Loadout a2) {
        this.b = string;
        this.c = a2;
        this.b();
    }
    ...
    public void a(String string, int n) {
        if (!this.containsKey(string)) {
            this.a((String)null, (rs.gui.b.Loadout)null);
            return;
        }
        if (n < 0 || n >= ((LoadoutGroup)this.get(string)).size()) {
            n = 0;
        }
        this.b = string;
        this.c = (rs.gui.b.Loadout)((LoadoutGroup)this.get(string)).get(n);
        this.b();
    }
    ...
    public void a(String string) {
        ...
        LoadoutGroup c2 = new LoadoutGroup(string);
        c2.add(new rs.gui.b.Loadout("Default"));
        this.put(string, c2);
        this.a.d();
        this.a.b();
        this.a(string, c2);
    ...
    public void a(String string, String string2) {
        ...
        for (String string3 : this.keySet()) {
            if (string3.equals(string)) {
                d2.put(string2, (LoadoutGroup)this.get(string3));
                bl = true;
                continue;
            }
            d2.put(string3, (LoadoutGroup)this.get(string3));
        }
        if (bl) {
            this.clear();
            for (String string3 : d2.keySet()) {
                this.put(string3, (LoadoutGroup)d2.get(string3));
            }
    ...
    public rs.gui.b.Loadout b(String string, String string2) {
        LoadoutGroup c2 = (LoadoutGroup)this.get(string);
        for (rs.gui.b.Loadout a2 : c2) {
            if (!a2.f().equals(string2)) continue;
            JOptionPane.showMessageDialog(null, "You already have a loadout with this name!", "Oops!", 2);
            return null;
        }
        rs.gui.b.Loadout a3 = new rs.gui.b.Loadout(string2);
        c2.add(a3);
        this.put(string, c2);
    ...
    public void a(String string, rs.gui.b.Loadout a2, String string2) {
        LoadoutGroup object2;
        ...
        if (!string2.equalsIgnoreCase(a2.f())) {
            for (Object object3 : (LoadoutGroup)this.get(string)) {
                if (!((rs.gui.b.Loadout)object3).f().equalsIgnoreCase(string2)) continue;
        ...
        String string3 = a2.f();
        a2.a(string2);
        object2 = new LoadoutGroup(string2);
        LoadoutGroup c2 = (LoadoutGroup)this.get(string);
        int n2 = 0;
        int n3 = 0;
        ...
        this.a.e().a(string, (List<rs.gui.b.Loadout>)object2);
        this.a.a(n2);
    ...
    public void a(String string, int n2, int n3) {
        ...
        rs.gui.b.Loadout a2 = (rs.gui.b.Loadout)c2.get(n2);
        rs.gui.b.Loadout a3 = (rs.gui.b.Loadout)c2.get(n3);
        c2.set(n2, a3);
        c2.set(n3, a2);
        this.put(string, c2);
        this.a.e().a(string, c2);
    ...
    public void c(String string, String string2) {
        ...
        for (String string3 : this.keySet()) {
            if (string3.equalsIgnoreCase(string)) {
                d2.put(string2, (LoadoutGroup)this.get(string2));
                continue;
            }
            if (string3.equalsIgnoreCase(string2)) {
                d2.put(string, (LoadoutGroup)this.get(string));
                continue;
            }
            d2.put(string3, (LoadoutGroup)this.get(string3));
        }
    ...
    public void a(String string, LoadoutGroup c2) {
        this.a.e().a(string, c2);
        this.a.e().b();
    }
    ...
    public void a() {
        ...
        this.a(this.b, (LoadoutGroup)this.get(this.b));
    }
    ...
    public rs.gui.b.Loadout c() {
        return this.c;
    }

    public LoadoutGroup d() {
        return (LoadoutGroup)this.get(this.b);
    }
