...
class b implements Runnable {
   b(a var1, int var2, String var3, String var4, String var5, String var6) {
      this.f = var1;
      this.a = var2;
      this.b = var3;
      this.c = var4;
   ...
   @Override
   public void run() {
      JLabel var1 = this.a == 1 ? rs.gui.c.a.a(this.f) : rs.gui.c.a.b(this.f);
      JLabel var2 = this.a == 1 ? rs.gui.c.a.c(this.f) : rs.gui.c.a.d(this.f);
      JLabel var3 = this.a == 1 ? rs.gui.c.a.e(this.f) : rs.gui.c.a.f(this.f);
      JLabel var4 = this.a == 1 ? rs.gui.c.a.g(this.f) : rs.gui.c.a.h(this.f);
