...
public class C_a extends SubstanceSkin {
   ...
   C_a() {
      ...
      var4.registerHighlightColorScheme(
         var1.get("RuneLite Highlight"), new ComponentState[]{ComponentState.SELECTED, ComponentState.ROLLOVER_SELECTED, ComponentState.ROLLOVER_UNSELECTED}
      );
      ...
      this.buttonShaper = new C_b(this);
      this.watermark = null;
