      ...
      switch (var3) {
         ...
         case "darkxmas":
            ...
            if (rs.p_f.C_a.r != var5) {
               ...
               rs.p_f.C_a.r = rs.p_f.C_a.b_mode.a;
            }
            ...
            var0.a(
               "<img=6> You've "
                  + (rs.p_f.C_a.r == rs.p_f.C_a.b_mode.e ? "enabled" : "disabled")
                  + " "
                  + var6
