...
public class a_0 {
    ...
    public void a_0(a a2) {
        this.f = a2;
    }

    public void a_0(c c2, int n2) {
        this.k.put(c2, new f(n2));
    }

    public void a_0(c c2, f f2) {
        this.k.put(c2, f2);
    }
    ...
    extends Enum<a> {
        ...
        private a_0(int n3, String string2, String string3) {
            this.f = n3;
            this.e = string2;
            this.d = string3;
        }
        ...
        public static a a_0(int n2) {
            for (a a2 : rs.gui.b_0.a$a.values()) {
                if (a2.c() != n2) continue;
                return a2;
            }
            return a;
