...
import rs.l_0.f.a_0.i.b;
import rs.l_0.j;
import rs.n_0.c_0.ac;
import rs.o_0;
import rs.x_0.f;
...
public class a_0 {
    ...
    public static void a_0(Client client, String string, String[] stringArray) {
        switch (string.toLowerCase()) {
            ...
            case "gfxdata": {
                ...
                System.out.println("GFX " + x2.d + ": model: " + x2.e_0 + ", anim:" + x2.f);
                break;
            }
            case "animdata": {
                rs.d.a a2 = rs.d.a.a[Integer.parseInt(stringArray[0])];
                System.out.println("frames: " + Arrays.toString(a2.e_0));
            ...
            case "tipint": {
                ...
                rs.l_0.f.a_0.i.e_0 e2 = rs.l_0.f.a_0.i.e_0.valueOf(stringArray[1].toUpperCase());
                int n5 = 0;
                int n6 = 0;
                int n7 = rs.n_0.e_0.H[n4].P;
                int n8 = rs.n_0.e_0.H[n4].P;
                if (rs.n_0.e_0.H[n4].E != null) {
                    n7 = rs.n_0.e_0.H[n4].E.n;
                    n8 = rs.n_0.e_0.H[n4].E.o;
                }
                switch (e2) {
                    case b: {
                        n5 = -30;
                ...
                rs.l_0.f.a_0.i.b.a(n4, e2, n5, n6);
                rs.l_0.f.a_0.i.b.k().b(true);
                break;
            }
            case "acc": {
                rs.l_0.f.e_0.d().h().a(stringArray[0], stringArray[1], stringArray[2]);
                break;
            }
            case "particle": {
                rs.l_0.f.e_0.d().g().b(20, 77, 125, 16764195);
                rs.l_0.f.e_0.d().g().b(10, 77, 125, 65315);
                break;
            }
            case "dumpcommands": {
                try {
            ...
            case "colors": {
                ...
                rs.a_0.h h2 = new rs.a_0.h(k.f((int)Integer.parseInt((String)stringArray[0])).A);
                ArrayList<Integer> arrayList = new ArrayList<Integer>();
            ...
            case "int": {
                ...
                if (stringArray[0].equalsIgnoreCase("edit")) {
                    if (rs.l_0.e_0.f.i.f() && stringArray.length == 0) {
                        rs.l_0.e_0.f.i.a(false);
                    } else {
                        rs.l_0.e_0.f.i.a(true);
                        rs.l_0.e_0.f.i.b(stringArray.length == 0 ? 0 : Integer.parseInt(stringArray[1]));
                    }
                }
                ...
                if (stringArray[0].equalsIgnoreCase("setmedia")) {
                    n16 = Integer.parseInt(stringArray[1]);
                    rs.n_0.e_0.H[n16].af = n15 = Integer.parseInt(stringArray[2]);
                }
                if (stringArray[0].equalsIgnoreCase("setmessage")) {
                    String string4;
                    n16 = Integer.parseInt(stringArray[1]);
                    rs.n_0.e_0.H[n16].at = string4 = stringArray[2];
                }
                if (stringArray[0].equalsIgnoreCase("print")) {
                    n16 = Integer.parseInt(stringArray[1]);
                    rs.n_0.e_0 e3 = rs.n_0.e_0.H[n16];
                    System.out.println();
                ...
                if (stringArray[0].equalsIgnoreCase("showall") || stringArray[0].equalsIgnoreCase("show")) {
                    boolean bl = rs.f_0.a.an = !rs.f_0.a.an;
                }
                ...
                for (int i8 = 30000; i8 <= 70000; ++i8) {
                    n14 = 0;
                    if (rs.n_0.e_0.H[i8] != null) continue;
                    n14 = 1;
                    for (int i9 = 1; i9 < n16; ++i9) {
                        if (rs.n_0.e_0.H[i8 + n16] == null) continue;
                        n14 = 0;
                    }
                    if (n14 == 0) continue;
            ...
            case "checkthing": {
                System.out.println("modelZoom = " + rs.n_0.e_0.H[4883].aT);
                System.out.println("modelRotation1 = " + rs.n_0.e_0.H[4883].aU);
                System.out.println("modelRotation2 = " + rs.n_0.e_0.H[4883].aV);
                break;
            }
            case "dumpitems": {
                client.a(false);
            ...
            case "texture": 
            case "textures": {
                rs.l_0.e_0.f.j.r = true;
                rs.l_0.e_0.f.j.s = 0;
                break;
            }
            case "gpuinv": {
                rs.k_0.e_0 cfr_ignored_0 = client.a;
                rs.k_0.e_0.a(true);
            }
        }
    }
    ...
    public static void b(Client client, String string, String[] stringArray) {
        switch (string.toLowerCase()) {
            ...
            case "chatcmdmode": {
                ...
                rs.f_0.a.O = !rs.f_0.a.O;
                client.a("<img=2> Chat command mode has been: " + (rs.f_0.a.O ? "@dgr@<img=24>ENABLED" : "@dre@<img=25>DISABLED"), 0, "");
                if (!rs.f_0.a.O) break;
            ...
            case "darkxmas": {
                ...
                rs.f_0.a.r = rs.f_0.a.r != b2 ? b2 : a.b.a;
                rs.f_0.a.p = rs.f_0.a.r == rs.f_0.a.o ? null : rs.f_0.a.r;
                rs.f_0.a.d();
                f f2 = client.a(2, "config", "config", client.eE[2], 30);
                client.a("<img=6> You've " + (rs.f_0.a.r == a.b.e_0 ? "enabled" : "disabled") + " " + string2 + " mode! Re-enter the command @blu@::summer@bla@ again to toggle.", 0, null);
                h.a(f2);
            ...
            case "renderself": {
                boolean bl = rs.f_0.a.N = !rs.f_0.a.N;
                if (rs.f_0.a.N) {
            ...
            case "multi": {
                boolean bl = rs.f_0.a.aX = !rs.f_0.a.aX;
                if (rs.f_0.a.aX) {
    ...
    public static void a_0(Client client, String string, int n2) {
        if (string.isEmpty()) {
            return;
        }
        if (!(string = string.replace("::", "")).contains(" ")) {
            rs.n_0.a_0.b(client, string, new String[0]);
            if (j.b(n2)) {
                rs.n_0.a_0.a(client, string, new String[0]);
            }
            return;
        }
        ...
        rs.n_0.a_0.b(client, stringArray[0], stringArray2);
        if (j.b(n2)) {
            rs.n_0.a_0.a(client, stringArray[0], stringArray2);
        }
    }

    public static void a_0(String string) {
        a.add(string);
    }
