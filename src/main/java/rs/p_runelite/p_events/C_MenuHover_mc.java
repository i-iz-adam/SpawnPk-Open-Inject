...
public class C_MenuHover_mc {
   public static C_MenuHover_mc SINGLETON = new C_MenuHover_mc();
   ...
   public static C_MenuHover_mc get() {
      return SINGLETON;
   }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof C_MenuHover_mc)) {
         return false;
      } else {
         C_MenuHover_mc var2 = (C_MenuHover_mc)var1;
   ...
   protected boolean canEqual(Object var1) {
      return var1 instanceof C_MenuHover_mc;
   }
