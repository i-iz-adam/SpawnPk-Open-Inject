...
public final class C_NavigationButtonAdded_mc {
   private final C_l button;

   public C_NavigationButtonAdded_mc(C_l var1) {
      this.button = var1;
   }
   ...
   public boolean equals(Object var1) {
      if (var1 == this) {
         return true;
      } else if (!(var1 instanceof C_NavigationButtonAdded_mc)) {
         return false;
      } else {
         C_NavigationButtonAdded_mc var2 = (C_NavigationButtonAdded_mc)var1;
