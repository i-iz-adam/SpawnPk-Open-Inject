...
public class MenuBuild {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof MenuBuild)) {
            return false;
        }
        MenuBuild menuBuild = (MenuBuild)object;
        if (!menuBuild.canEqual(this)) {
            return false;
        }
        if (this.getRow() != menuBuild.getRow()) {
            return false;
        }
        if (this.getMenuId() != menuBuild.getMenuId()) {
            return false;
        }
        if (this.getMenuCmd1() != menuBuild.getMenuCmd1()) {
            return false;
        }
        if (this.getMenuCmd2() != menuBuild.getMenuCmd2()) {
            return false;
        }
        if (this.getMenuCmd3() != menuBuild.getMenuCmd3()) {
            return false;
        }
        if (this.getMenuCmd4() != menuBuild.getMenuCmd4()) {
            return false;
        }
        String string = this.getTooltip();
        String string2 = menuBuild.getTooltip();
        return !(string == null ? string2 != null : !string.equals(string2));
    }

    protected boolean canEqual(Object object) {
        return object instanceof MenuBuild;
    }
    ...
    public String toString() {
        return "MenuBuild(tooltip=" + this.getTooltip() + ", row=" + this.getRow() + ", menuId=" + this.getMenuId() + ", menuCmd1=" + this.getMenuCmd1() + ", menuCmd2=" + this.getMenuCmd2() + ", menuCmd3=" + this.getMenuCmd3() + ", menuCmd4=" + this.getMenuCmd4() + ")";
    }
}
