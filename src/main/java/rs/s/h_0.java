...
@e(a="runelite")
public interface h_0
extends b {
    public static final String a = "runelite";
    @rs.e_0.l(a="Window Settings", b="Settings relating to the client's window and frame", c=0)
    public static final String b = "windowSettings";
    @rs.e_0.l(a="Notification Settings", b="Settings relating to notifications", c=1)
    public static final String c = "notificationSettings";
    @rs.e_0.l(a="Overlay Settings", b="Settings relating to fonts", c=2)
