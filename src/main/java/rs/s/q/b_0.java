...
extends m {
    ...
    private final rs.s_0.q.b_0.a b = new rs.s_0.q.b_0.a(rs.s_0.q.d.e.i());
    private final a c;
    private final d d;

    @Inject
    private b_0(d d2, a a2) {
        super(false);
        this.d = d2;
        this.c = a2;
        ...
        this.add(new rs.s_0.q.b_0.b("Current Fight", false));
        ...
        rs.s_0.q.b_0.b b2 = new rs.s_0.q.b_0.b("Fight History (Filter by Usernames):", true);
        this.add(b2);
    ...
    public void a(ArrayList<rs.s_0.q.a_0.a> arrayList) {
        if (!this.c.c().isEmpty()) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            arrayList.forEach(a2 -> this.a.add((Component)new rs.s_0.q.b_0.a((rs.s_0.q.a_0.a)a2), 0));
            this.updateUI();
        });
    }
    ...
    public void b_0() {
        this.a.removeAll();
        if (!this.d.j().isEmpty()) {
            ArrayList<rs.s_0.q.a_0.a> arrayList = new ArrayList<rs.s_0.q.a_0.a>(this.d.j());
            this.a(arrayList);
        }
        SwingUtilities.invokeLater(this::updateUI);
    }

    public rs.s_0.q.b_0.a c() {
        return this.b;
    }
}
