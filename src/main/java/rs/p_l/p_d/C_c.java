...
public class C_c implements Runnable {
   ...
   public static boolean BOOL_A = true;
   ...
   static C_Client_mc a(C_c value) {
      return value.v;
   }


   static void a(C_c value, String text) {
      value.C = text;
   }

   static void a(C_c value, int width) {
      value.A = width;
   }

   static String b(C_c value) {
      return value.C;
   }

   static void b(C_c value, String url) {
      value.an = url;
   }

   static String c(C_c value) {
      return value.an;
   }

   static void c(C_c value, String text) {
      value.am = text;
   }

   static String d(C_c value) {
      return value.am;
   }

   static void d(C_c value, String text) {
      value.C = text;
   }

   static String e(C_c value) {
      return value.C;
   }
