...
public abstract class C_f {
   ...
   public void a(C_Client_mc var1, C_f var2) {
      this.a(var1, var2 == Mode.a ? C_f.Mode.a : C_f.Mode.b);
   }

   public void a(C_Client_mc var1, C_f.Mode var2) {
      if (this.a(var1)) {
         this.q = true;
         this.b(var1, var2);
      } else {
   ...
   public abstract void b(C_Client_mc var1, C_f.Mode var2);
