...
class C_H_uc extends RGBImageFilter {
   ...
   public final int filterRGB(int var1, int var2, int var3) {
      ...
      if (C_F_uc.h(var5, this.b.getRed()) && C_F_uc.h(var6, this.b.getGreen()) && C_F_uc.h(var7, this.b.getBlue())) {
         var5 = C_F_uc.i(var5, this.b.getRed(), this.c.getRed());
         var6 = C_F_uc.i(var6, this.b.getGreen(), this.c.getGreen());
         var7 = C_F_uc.i(var7, this.b.getBlue(), this.c.getBlue());
      }
