...
implements w {
    ...
    @Override
    public Dimension a_0(Graphics2D graphics2D) {
    ...
    public a_0(Color color, Rectangle rectangle, boolean bl) {
        this.f = color;
        this.g = rectangle;
        this.h = bl;
    }
    ...
    public void a_0(Rectangle rectangle) {
        this.g = rectangle;
    }

    public void a_0(boolean bl) {
        this.h = bl;
    }
}
