...
public class C_a {
   ...
   public void b(Map<Integer, Map<String, Object>> var1) {
      if (this instanceof C_c) {
         for (int var3 : var1.keySet()) {
            ...
            for (String var6 : ((Map<String, Object>)var1.get(var3)).keySet()) {
               if (var6.equalsIgnoreCase("textures")) {
                  Map<?, ?> var7 = (Map<?, ?>)((Map<?, ?>)var1.get(var3)).get(var6);
                  int[][][] var8 = new int[var7.size()][][];
                  int var9 = 0;

                  for (Object var11Obj : var7.keySet()) {
                     int var11 = ((Number)var11Obj).intValue();
                     List<?> var12 = (List<?>)var7.get(var11Obj);
                     var8[var9] = new int[2][];
            ...
            for (Object var18Obj : var4.keySet()) {
               String var18 = (String)var18Obj;
   ...
   protected int[] a(Object var1) {
      return var1 != null && ((List<?>)var1).size() != 0 ? ((List<?>)var1).stream().mapToInt(x -> ((Number)x).intValue()).toArray() : null;
   }
