...
public final class a_0 {
    ...
    public a_0(RandomAccessFile randomAccessFile, RandomAccessFile randomAccessFile2, int n2) {
        this.b = randomAccessFile;
        this.c = randomAccessFile2;
        this.d = n2;
    }

    public synchronized byte[] a_0(int n2) {
        try {
            int n3;
            int n4;
            this.a(this.c, n2 * 6);
    ...
    public synchronized boolean a_0(int n2, byte[] byArray, int n3) {
    ...
    private synchronized boolean a_0(boolean bl, int n2, int n3, byte[] byArray) {
        try {
            int n4;
            int n5;
            int n6;
    ...
    private synchronized void a_0(RandomAccessFile randomAccessFile, int n2) {
