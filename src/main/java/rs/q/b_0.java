...
implements Runnable {
    ...
    public b_0(c_0 c_02, Socket socket) {
        this.e = c_02;
        this.c = socket;
        if (rs.f_0.a.l.booleanValue()) {
            this.c.setSoTimeout(30000);
        } else {
            this.c.setSoTimeout(0);
        }
        this.c.setTcpNoDelay(true);
        this.c.setReceiveBufferSize(rs.f_0.a.bt);
    ...
    public void a(int n2, byte[] byArray) {
        ...
        if (this.f == null) {
            this.f = new byte[rs.f_0.a.bt.intValue()];
        }
        b b2 = this;
        synchronized (b2) {
            for (int i2 = 0; i2 < n2; ++i2) {
                this.f[this.h] = byArray[i2];
                this.h = (this.h + 1) % rs.f_0.a.bt;
                if (this.h != (this.g + 4900) % rs.f_0.a.bt) continue;
    ...
    public void run() {
        while (this.i) {
            ...
            synchronized (b2) {
                ...
                n3 = this.g;
                n2 = this.h >= this.g ? this.h - this.g : rs.f_0.a.bt - this.g;
            }
            if (n2 <= 0) continue;
            try {
