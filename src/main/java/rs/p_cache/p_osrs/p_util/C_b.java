...
class C_b extends C_f {
   final C_OsrsMapDependencyScanner_mc e;
   final byte[] a;
   final byte[] b;
   final byte[] c;
   final byte[] d;
   ...
   public void a() {
      try {
         this.i = C_OsrsMapDependencyScanner_mc.b(this.e.a().resolve("configs/objects.yaml"));
         this.h.clear();

         for (int var2 : this.i.keySet()) {
            Map var3 = this.i.get(var2);
            boolean var4 = var3.keySet().stream().anyMatch(var0 -> var0 instanceof String && ((String)var0).equalsIgnoreCase("forceAllRevisions"));
            if (Boolean.TRUE.equals(var3.get("osrs")) || var4) {
               ...
               this.h.a(var2, this.a(var2, var3));
            }
         }
