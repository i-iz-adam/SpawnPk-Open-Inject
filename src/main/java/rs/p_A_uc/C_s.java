...
public class C_s {
   ...
   private static final Joiner e = Joiner.on(",").skipNulls();
   public static final CharMatcher a = CharMatcher.javaIsoControl();

   public static List<String> a(String var0) {
      return d.splitToList(var0);
   }
   ...
   public static String e(String var0) {
      return CharMatcher.javaIsoControl().removeFrom(var0.replaceAll("[ _-]", " ")).trim();
   }
