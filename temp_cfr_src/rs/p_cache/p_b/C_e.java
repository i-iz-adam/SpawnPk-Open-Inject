...
public class C_e {
    ...
    public C_e(String string, String string2) {
        this.e = string;
        this.d = string2;
    }
    ...
    public double b() {
        try {
            ...
            jEditorPane.addHyperlinkListener(new C_f(this));
