...
public class C_ai extends rs.p_n.C_c {
   ...
   public static void h() {
      ...
      rs.p_n.C_e.H['褙'].at = StringConcatFactory.makeConcatWithConstants<"makeConcatWithConstants","\u0001">(d[rs.p_f.C_a.bh]);
      rs.p_n.C_e.H['褤'].at = StringConcatFactory.makeConcatWithConstants<"makeConcatWithConstants","\u0001">(d[rs.p_f.C_a.bi]);
   }
   ...
   public static void o(int var0) {
      rs.p_f.C_a.bh = var0;
      rs.p_n.C_e.H['褙'].at = StringConcatFactory.makeConcatWithConstants<"makeConcatWithConstants","\u0001">(d[var0]);
      rs.p_f.C_a.d();
   }

   public static void p(int var0) {
      rs.p_f.C_a.bi = var0;
      rs.p_n.C_e.H['褤'].at = StringConcatFactory.makeConcatWithConstants<"makeConcatWithConstants","\u0001">(d[var0]);
      rs.p_f.C_a.d();
   }
