...
public class C_au extends rs.p_n.C_c {
   public C_au(rs.p_l.C_K_uc[] var1) {
      super(var1);
   }

   public static void h() {
      rs.p_n.C_e.H[25343].at = "";
      rs.p_n.C_e.H[25344].at = "";
      c(25342, 0, 32);
   }

   @Override
   public void a() {
      rs.p_n.C_e var1 = d(24632);
      ...
      a(25339, "Coins", "Select", this.a, 0, 12171349, false, true, 160);
      a(25340, "100M bags", "Select", this.a, 0, 12171349, false, true, 160);
      ...
      var1.k(27);
      var1.b(0, 65774, 82, 81);
      var1.b(1, 65775, 261, 89);
      var1.b(2, 65418, 414, 89);
      var1.b(3, 65419, 414, 89);
      var1.b(4, 25342, 92, 115);
      var1.b(5, 25343, 205, 126);
      var1.b(6, 25344, 354, 126);
      var1.b(7, 65451, 142, 156);
      var1.b(8, 25337, 93, 182);
      var1.b(9, 25339, 113, 184);
      var1.b(10, 25338, 93, 202);
      var1.b(11, 25340, 113, 204);
      var1.b(12, 25345, 235, 153);
      var1.b(13, 25346, 235, 153);
      var1.b(14, 65421, 285, 163);
      var1.b(15, 25348, 235, 183);
      var1.b(16, 25349, 235, 183);
      var1.b(17, 65422, 285, 193);
      var1.b(18, 25351, 235, 213);
      var1.b(19, 25352, 235, 213);
      var1.b(20, 65423, 285, 223);
      var1.b(21, 25354, 351, 200);
      var1.b(22, 25355, 351, 200);
      var1.b(23, 65424, 387, 213);
      var1.b(24, 65425, 386, 164);
      var1.b(25, 25104, 90, 89);
      var1.b(26, 25105, 90, 89);
   }
}
