   ...
   public static C_k a(int var0, boolean var1, boolean var2) {
      ...
      if (var4.w != null) {
         ...
         if (C_p.a.w_(var0) && var4.w.contains("@gre@")) {
            var4.w = ((C_p.a)C_p.a.b(var0)).d + var4.w.substring(5);
         }
      }

      if (var4.x == null) {
         var4.x = StringConcatFactory.makeConcatWithConstants<"makeConcatWithConstants","\u0001">(var4.w);
      }
