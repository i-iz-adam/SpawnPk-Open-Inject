...
public class C_b extends rs.p_t.C_c<rs.p_d.C_d> {
   ...
   public rs.p_d.C_d b(int var1, Map<String, Object> var2) {
      ...
      if (var2.containsKey("clone")) {
         ...
         if (this.i.containsKey(var4)) {
            if (!this.h.w_(var4)) {
               var3.a(this.b(var4, this.i.get(var4)));
            } else {
      ...
      for (String var5 : var2.keySet()) {
         ...
         switch (var7) {
            ...
            case "textures":
               ...
               for (int var12 : var10.keySet()) {
                  var3.i.a().a(var12, this.a(var10.get(var12)));
               }
               break;
            case "srccolors":
               var3.v = this.a(var6);
