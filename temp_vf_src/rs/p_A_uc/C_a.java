...
public class C_a {
   private final p<C_a.a, C_d> a = d.a().a(128L).b(1L, TimeUnit.HOURS).a(new C_b(this));
   private final p<C_a.b, C_d> b = d.a().a(128L).b(1L, TimeUnit.HOURS).a(new C_c(this));
   ...
   public C_d a(int var1, int var2, int var3) {
      try {
         return (C_d)this.a.e(new C_a.a(var1, var2, var3));
   ...
   public C_d a(String var1, int var2) {
      try {
         return (C_d)this.b.e(new C_a.b(var1, var2));
