...
public class C_a extends JPanel {
   ...
   public void a(int var1, String var2, String var3, String var4, String var5) {
      EventQueue.invokeLater(new C_b(this, var1, var2, var3, var4, var5));
   }

   public void b(int var1, String var2, String var3, String var4, String var5) {
      EventQueue.invokeLater(new C_c(this, var1, var2, var3, var4, var5));
   }
   ...
   private void b() {
      if (C_Client_mc.class.getResource("Client.class").toString().startsWith("file")) {
         ...
         try {
            this.w = new ImageIcon(ImageIO.read(C_Client_mc.class.getResource("/assets/gui/ico_user.png")));
            this.x = new ImageIcon(ImageIO.read(C_Client_mc.class.getResource("/assets/gui/ico_skull.png")));
            this.y = new ImageIcon(ImageIO.read(C_Client_mc.class.getResource("/assets/gui/ico_pray.png")));
            this.z = new ImageIcon(ImageIO.read(C_Client_mc.class.getResource("/assets/gui/ico_damage.png")));
            this.A = new ImageIcon(ImageIO.read(C_Client_mc.class.getResource("/assets/gui/ico_magic.png")));
