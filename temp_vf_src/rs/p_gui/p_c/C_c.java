...
class C_c implements Runnable {
   ...
   @Override
   public void run() {
      JLabel var1 = this.a == 1 ? C_a.k(this.f) : C_a.l(this.f);
      JLabel var2 = this.a == 1 ? C_a.m(this.f) : C_a.n(this.f);
      JLabel var3 = this.a == 1 ? C_a.o(this.f) : C_a.p(this.f);
      JLabel var4 = this.a == 1 ? C_a.q(this.f) : C_a.r(this.f);
