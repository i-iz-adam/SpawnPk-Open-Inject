...
public class C_M_uc {
   private static final Logger a = LoggerFactory.getLogger(C_M_uc.class);

   public static void a() {
      ToolTipManager.sharedInstance().setLightWeightPopupEnabled(false);
      ToolTipManager.sharedInstance().setInitialDelay(300);
      UIManager.put("TabbedPane.selected", C_d.c);
      UIManager.put("TabbedPane.highlight", C_d.c);
      UIManager.put("TabbedPane.contentAreaColor", C_d.c);
      UIManager.put("TabbedPane.borderHightlightColor", C_d.c);
      UIManager.put("TabbedPane.darkShadow", C_d.c);
      UIManager.put("Button.foreground", Color.WHITE);
      UIManager.put("MenuItem.foreground", Color.WHITE);
      UIManager.put("Panel.background", C_d.d);
      UIManager.put("TextField.selectionBackground", C_d.b);
      UIManager.put("TextField.selectionForeground", Color.WHITE);
      UIManager.put("FormattedTextField.selectionBackground", C_d.b);
      UIManager.put("FormattedTextField.selectionForeground", Color.WHITE);
      UIManager.put("TextArea.selectionBackground", C_d.b);
   ...
   public static void a(@Nonnull LookAndFeel var0) {
      try {
         ...
         if (rs.p_k.C_j.a() == rs.p_k.C_j.b) {
            PopupFactory.setSharedInstance(new rs.p_A_uc.C_m());
         }
   ...
   public static JButton a(@Nonnull rs.p_ui.C_l var0, int var1, @Nullable BiConsumer<rs.p_ui.C_l, JButton> var2) {
      BufferedImage var3 = var1 > 0 ? rs.p_A_uc.C_j.a(var0.b(), var1, var1) : var0.b();
   ...
   public static TrayIcon a(@Nonnull Image var0, @Nonnull String var1, @Nonnull Frame var2) {
      if (!SystemTray.isSupported()) {
         ...
         var4.addMouseListener(new C_N_uc(var2));
         return var4;
      }
   }
}
